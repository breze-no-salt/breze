...
def exprs(inpt_mean, inpt_var, in_to_hidden,
    ...
    output = T.concatenate([output_mean, output_var], axis=1) # here happens the doubling of the latent layer to hold both mean and var
    ...
    exprs.update({
        ...
        'output_mean': output_mean, # corrected from output_in_mean
        'output_var': output_var, # corrected from output_in_var
        'output': output,
    })
